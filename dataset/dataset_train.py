...
class TrainDataset(BaseDataset):
    ...
    def __init__(self, ann_list, config, **kwargs):
        ...
        if feat_file in TrainDataset.cached_feats and img_feat_file in TrainDataset.cached_feats and feats_gnn_file in TrainDataset.cached_feats:
            ...
            (self.scene_gnn_feats, self.scene_foreground_ids) = TrainDataset.cached_feats[feats_gnn_file]
        else:
            ...
            TrainDataset.cached_feats[feats_gnn_file] = (self.scene_gnn_feats, self.scene_foreground_ids)
    ...
    def __getitem__(self, index):
        ...
        return scene_feat, scene_img_feat, scene_mask, scene_locs, obj_id, assigned_ids, scene_gnn_feats, scene_foreground_ids, caption, question


def train_collate_fn(batch):
    scene_feats, scene_img_feats, scene_masks, scene_locs, obj_ids, assigned_ids, scene_gnn_feats, scene_foreground_ids, captions, questions = zip(*batch)
