...
val_tag="scanrefer#multi3dref#sqa3d"
...
pretrained_path="outputs/quatrope-igre-m3d-finetune-7b-knn-2/ckpt_02_77139.pth"
OUTPUT_DIR="outputs/quatrope-igre-m3d-finetune-7b-knn-2/epoch02"
mkdir -p ${OUTPUT_DIR}
