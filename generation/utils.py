    ...
    def _beam_search(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            # vicuna !!!
            if "obj_pos" in model_kwargs:  # QuatRoPE
                model_inputs["obj_pos"] = model_kwargs["obj_pos"]
            if "obj_typ" in model_kwargs:  # QuatRoPE
                model_inputs["obj_typ"] = model_kwargs["obj_typ"]
            if "rope_mode_cfg" in model_kwargs:
                model_inputs["rope_mode_cfg"] = model_kwargs["rope_mode_cfg"]
            if "multiview_pos" in model_kwargs:  # DiRoPE
                model_inputs["multiview_pos"] = model_kwargs["multiview_pos"]
